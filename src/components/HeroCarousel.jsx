    ...
    <div className="relative h-[85vh] w-full overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-6">
        <div className="animate-fade-in max-w-4xl">
          <span className="inline-block text-xs uppercase tracking-widest text-white/90 font-light mb-6">
          ...
          <p className="max-w-2xl text-base md:text-lg font-light mb-10 leading-relaxed text-white/90">
      ...
      <button
        onClick={prevSlide}
        className="absolute top-1/2 left-6 -translate-y-1/2 w-12 h-12 border border-white/30 hover:bg-white/10 text-white transition-all flex items-center justify-center group"
      >
      ...
      <button
        onClick={nextSlide}
        className="absolute top-1/2 right-6 -translate-y-1/2 w-12 h-12 border border-white/30 hover:bg-white/10 text-white transition-all flex items-center justify-center group"
      >
        <span className="text-2xl font-light group-hover:translate-x-1 transition-transform">
          ›
        </span>
