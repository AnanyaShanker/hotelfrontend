    ...
    >
      ...
      >
        <div className="px-6 py-6 flex flex-col gap-4">
          ...
          {!isStaff() && <a href="/facilities" className="py-2 text-xs text-neutral-700 font-light uppercase tracking-wider hover:text-neutral-400 transition">Facilities</a>}
          {!isStaff() && <a href="/rooms" className="py-2 text-xs text-neutral-700 font-light uppercase tracking-wider hover:text-neutral-400 transition">Rooms</a>}
          {!isStaff() && <a href="/gallery" className="py-2 text-xs text-neutral-700 font-light uppercase tracking-wider hover:text-neutral-400 transition">Gallery</a>}
          ...
          {isAuthenticated && isCustomer() && (
            <>
              ...
              <a href="/my-tickets" className="py-2 text-xs text-neutral-700 font-light uppercase tracking-wider hover:text-neutral-400 transition">Raised Tickets</a>
            </>
          )}
