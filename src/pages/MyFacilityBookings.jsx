...
export default function MyFacilityBookings() {
  ...
  useEffect(() => {
    ...
    fetchBookings();
  }, [isAuthenticated, authLoading, navigate, fetchBookings]);
  ...
  const handleCancelBooking = async () => {
    ...
    setCancelling(true);
    try {
      await cancelFacilityBooking(bookingToCancel, user.userId);
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div className="flex flex-col gap-2 md:ml-6">
                  ...
                  {booking.bookingStatus === "CONFIRMED" && (
                    <button
                      onClick={() => handleCancelClick(booking.facilityBookingId)}
                      className="px-6 py-2 border border-red-300 text-red-700 text-xs uppercase tracking-widest font-light hover:border-red-400 hover:bg-red-50 transition whitespace-nowrap"
                    >
                      Cancel Booking
                    </button>
                  )}
          ...
          <div className="bg-white max-w-lg w-full">
            ...
            <div className="border-b border-neutral-200 p-6">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  disabled={cancelling}
                  className="text-neutral-600 hover:text-neutral-900 text-2xl font-light disabled:opacity-50"
                >
                  ×
                </button>
              </div>
            ...
            <div className="p-6 space-y-6">
              <div className="space-y-4">
                <p className="text-neutral-700 font-light text-sm">
                  Are you sure you want to cancel this facility booking?
                </p>
            ...
            <div className="border-t border-neutral-200 p-6 flex justify-end gap-4">
              <button
                ...
                disabled={cancelling}
                className="px-6 py-3 border border-neutral-300 text-neutral-800 text-xs uppercase tracking-widest font-light hover:border-neutral-400 transition disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Keep Booking
              </button>
              <button
