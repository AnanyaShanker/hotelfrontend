...
export default function PaymentList() {
  ...
  if (loading) {
    return <p className="text-center mt-12 text-blue-700 animate-pulse">Loading payments…</p>;
  }
  ...
  return (
    <div className="p-10">
      <h1 className="text-3xl font-extrabold text-gray-900 mb-10">💳 Payments Dashboard</h1>
      ...
      <div className="grid md:grid-cols-2 gap-12 mb-16">
        <div className="p-8 bg-white border border-blue-200 rounded-xl shadow-md">
          <h2 className="text-blue-900 text-lg mb-4 font-bold">📈 Payment Status Distribution</h2>
          <Pie data={pieData} />
        </div>

        <div className="p-8 bg-white border border-blue-200 rounded-xl shadow-md">
          <h2 className="text-blue-900 text-lg mb-4 font-bold">💳 Payment Methods</h2>
          <Bar data={barData} />
        </div>
      </div>
          ...
          <tbody>
            {payments.map((p) => (
              <tr key={p.paymentId} className="text-center hover:bg-blue-50 transition">
                ...
                <td className="p-3 border font-semibold text-green-700">₹{p.amountPaid}</td>
